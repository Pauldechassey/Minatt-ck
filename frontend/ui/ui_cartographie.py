...
"}")
        ...
        self.gridLayoutMenuCartographie.addWidget(self.pushButtonAttaquesCartographie, 0, 3, 1, 1)
...
"}")
        ...
        self.gridLayoutMenuCartographie.addWidget(self.pushButtonCartographieCartographie, 0, 6, 1, 1)
...
"")
        ...
        self.gridLayoutMenuCartographie.addWidget(self.pushButtonDeconnexionCartographie, 0, 8, 1, 1)
...
"}")
        ...
        self.gridLayoutMenuCartographie.addWidget(self.pushButtonRapportsCartographie, 0, 5, 1, 1)

        self.pushButtonAuditsCartographie = QPushButton(Cartographie)
        self.pushButtonAuditsCartographie.setObjectName(u"pushButtonAuditsCartographie")
        self.pushButtonAuditsCartographie.setStyleSheet(u"QPushButton {\n"
"    background-color: #00C853; /* Vert */\n"
"    color: white;\n"
"    font-weight: bold;\n"
"    border-radius: 5px;\n"
...
"}")
        ...
        self.gridLayoutMenuCartographie.addWidget(self.pushButtonAuditsCartographie, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Cartographie):
        ...
        self.pushButtonAuditsCartographie.setText(QCoreApplication.translate("Cartographie", u"Audits", None))
