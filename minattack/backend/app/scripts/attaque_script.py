...
from minattack.backend.app.scripts.sqli_script import SQLIScanner
from minattack.backend.app.scripts.xss_script import XSSScanner
from minattack.backend.app.scripts.csrf_script import CSRFScanner
from minattack.backend.app.scripts.headers_cookies_script import HeadersCookiesScanner
