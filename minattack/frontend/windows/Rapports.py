...
class RapportsWindow(QWidget, Ui_Rapports):
    def __init__(self, main_window, parent=None):
        ...
        self.ui.pushButtonDownload.clicked.connect(self.download_rapport)
    ...
    def display_rapport(self, audit_id: int):
        ...
        if pdf_content:
            ...
            with tempfile.NamedTemporaryFile(suffix='.pdf', delete=False) as tmp:
                ...
                print(f"[DEBUG] PDF saved to temporary file: {self.temp_pdf_path}")
